...
$scope.LoadGS = function() {$App.copyright = "Copyright © 2022-"+$App.NAB.Year+" ::www.TiantekPro.com ::, All rights reserved.   >>>> This page is designed only for desktop. <<<<";
$App.GSheet1 = "https://docs.google.com/spreadsheets/d/1R4c0daj1PVgyhcBp4cvfDTOHrnkB0K9iqXbPOTgDGLo/edit#gid=1434656569";
neoGSheetsLoadCell($App.GSheet1,"ora1","b",1,null);

neoGSheetsLoadCell($App.GSheet1,"ora2","b",2,null);

neoGSheetsLoadCell($App.GSheet1,"ora3","b",3,null);

neoGSheetsLoadCell($App.GSheet1,"ora4","b",4,null);

neoGSheetsLoadCell($App.GSheet1,"ora5","b",5,null);

neoGSheetsLoadCell($App.GSheet1,"ora6","b",6,null);

neoGSheetsLoadCell($App.GSheet1,"ora7","b",7,null);

neoGSheetsLoadCell($App.GSheet1,"ora8","b",8,null);

neoGSheetsLoadCell($App.GSheet1,"ora9","b",9,null);

neoGSheetsLoadCell($App.GSheet1,"ora10","b",10,null);

neoGSheetsLoadCell($App.GSheet1,"ora11","b",11,null);

neoGSheetsLoadCell($App.GSheet1,"ora12","b",12,null);

neoGSheetsLoadCell($App.GSheet1,"ora13","b",13,null);

neoGSheetsLoadCell($App.GSheet1,"ora14","b",14,null);

neoGSheetsLoadCell($App.GSheet1,"ora15","b",15,null);

neoGSheetsLoadCell($App.GSheet1,"ora16","b",16,null);

neoGSheetsLoadCell($App.GSheet1,"ora17","b",17,null);

neoGSheetsLoadCell($App.GSheet1,"ora18","b",18,null);

neoGSheetsLoadCell($App.GSheet1,"ora19","b",19,null);

neoGSheetsLoadCell($App.GSheet1,"ora20","b",20,null);

neoGSheetsLoadCell($App.GSheet1,"ora21","b",21,null);

neoGSheetsLoadCell($App.GSheet1,"ora22","b",22,null);

neoGSheetsLoadCell($App.GSheet1,"ora23","b",23,null);

neoGSheetsLoadCell($App.GSheet1,"ora24","b",24,null);

neoGSheetsLoadCell($App.GSheet1,"ora25","b",25,null);

neoGSheetsLoadCell($App.GSheet1,"ora26","b",26,null);

neoGSheetsLoadCell($App.GSheet1,"ora27","b",27,null);

neoGSheetsLoadCell($App.GSheet1,"ora28","b",28,null);
};
